...
\begin{table}[h]
  ...
  \begin{tabular}{@{}lccccc@{}}
    ...
    \midrule
    CODA (Li et al., 2022)                 & \textcolor{red}{\textbf{X}} & \checkmark                  & \checkmark            & \checkmark             & \textcolor{red}{\textbf{X}} \\
    StreetHazards (Hendrycks et al., 2019) & \textcolor{red}{\textbf{X}} & \checkmark                  & \checkmark            & \checkmark             & \textcolor{red}{\textbf{X}} \\
    nuScenes-QA (Qian et al., 2023)        & \checkmark                  & \textcolor{red}{\textbf{X}} & \checkmark            & \checkmark             & \textcolor{red}{\textbf{X}} \\
    BDD-X (Kim et al., 2018)               & \checkmark                  & \checkmark                  & \checkmark            & \checkmark             & \textcolor{red}{\textbf{X}} \\
    DRAMA (Malla et al., 2023)             & \checkmark                  & \checkmark                  & \checkmark            & \checkmark             & \checkmark                  \\
    DriveLM (Sima et al., 2023)            & \checkmark                  & \checkmark                  & \checkmark            & \checkmark             & \checkmark                  \\
    \rowcolor[HTML]{DAE8FC}
    CODA-LM (ours)                         & \checkmark                  & \checkmark                  & \checkmark            & \checkmark             & \checkmark                  \\
    \bottomrule
  \end{tabular}
\end{table}
