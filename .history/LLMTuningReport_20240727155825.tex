...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccccccccccc}
    ...
    \midrule
    \rowcolor{gray!20} CODA-VLM (ours) & \textbf{55.04}      & \textbf{77.68}                                    & \textbf{78.79}       & \textbf{73.80} & \textbf{64.86} & \textbf{73.33} & \textbf{86.18} & \textbf{78.72}   & \textbf{68.75} & \textbf{58.14}      \\
    \bottomrule
  \end{tabular}
\end{table}
