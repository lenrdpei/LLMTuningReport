...
\begin{figure}[ht] 
    \centering 
    \includegraphics[width=0.75\textwidth]{fig/\detokenize{R.jpg}}
    \caption{提问用图} 
...
\begin{figure}[ht] 
    \centering 
    \includegraphics[width=0.75\textwidth]{fig/\detokenize{13b_0-.jpg}}
...
以7b的10epoch模型为例，对于部分问题的回答如图\ref{7b_10}所示：

\begin{figure}[ht] 
    \centering 
    \includegraphics[width=0.75\textwidth]{fig/\detokenize{7b_10.jpg}}
